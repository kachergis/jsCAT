...
Not yet supported (open areas for future work): non-D-optimal selection criteria (e.g. `Wrule`, KL information), and correlated (non-orthogonal) prior covariance structures beyond what you supply directly via `priorCovariance`.
